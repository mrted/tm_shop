...
urlpatterns = [
    ...
    path('category_detail/<slug:category_slug>', views.category_details, name='category-detail'),
    ...
    path('account/detail/', views.signupView, name='signup'),
    ...
    # path('brands/', views.brands, name='product-brands')
