...
def home(request, category_slug=None):
    ...
    return render(request, 'home.html', {'category': category_page, 'product_list': product_list})
...
def category_details(request, category_slug=None):
    ...
    if category_slug != None:
       ...
       product_list = Product.objects.all().filter(available=True)
    return render(request, 'category-detail.html', {'product_list': product_list})
...
def productPage(request, category_slug, product_slug):
    ...
    return render(request, 'product-details.html', {'product': product, 'reviews': reviews})
...
def search(request):
    search_result = Product.objects.filter(product_name__contains=request.GET['title'])
